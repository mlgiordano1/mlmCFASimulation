...
saveRDS(l_sub, "./finalResults/trueModelComparisons.RDS")
rm(list="l_sub")
# -----------------------------------------------------------------------------
...
l_sub <- processDF(l_sub)
# save it so .RMD can read it in
saveRDS(l_sub, "./finalResults/MisW1Comparisons.RDS")
rm(list="l_sub")
# -----------------------------------------------------------------------------
...
l_sub <- processDF(l_sub)
# save it so .RMD can read it in
saveRDS(l_sub, "./finalResults/MisW2Comparisons.RDS")
rm(list="l_sub")
# -----------------------------------------------------------------------------
# misspecW3  ------------------------------------------------------------------
# subset what we want
...
l_sub <- processDF(l_sub)
# save it so .RMD can read it in
saveRDS(l_sub, "./finalResults/MisW3Comparisons.RDS")
rm(list="l_sub")
# -----------------------------------------------------------------------------
...
# subset what we want
# l_sub <- subset(dm, dm$skewKurt=="0000")
l_sub <- subset(dm, dm$clusterBal=="bal")
l_sub <- subset(l_sub, l_sub$modelSpec=="trueModel")
...
l_sub <- processDF(l_sub)
# save it so .RMD can read it in
saveRDS(l_sub, "./finalResults/skewKurt.RDS")
rm(list="l_sub")
# -----------------------------------------------------------------------------
# 
# balance  ------------------------------------------------------------------
